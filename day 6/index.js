...
function gameOver(a) {
    var gameOverAlertElement = "<div class='alert'><b>GAME OVER</b><br><br> Player " + span[a].dataset.player.toUpperCase() + " Wins!!!<br><br>" + restartButton + "</div>";
...
function draw() {
    var drawAlertElement = "<div class='alert'><b>DRAW!!!</b><br><br>" + restartButton + "</div>";
    var div = document.createElement("div");
    div.className = "alert";
